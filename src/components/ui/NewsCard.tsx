...
const NewsCard: React.FC<NewsCardProps> = ({ image, title, description, isSmall = false, slug }) => {
  return (
    <Link href={slug ? `/bai-viet/${slug}` : "#"} className={`block ${isSmall ? "flex items-center space-x-4 p-2" : ""}`}>
